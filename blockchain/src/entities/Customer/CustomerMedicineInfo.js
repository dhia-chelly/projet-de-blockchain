...
export default function CustomerMedicineInfo(props) {
  ...
  function getSupplyChainStepContent(stepIndex) {
    switch (stepIndex) {
      ...
      case 3:
        return "Medicine is collected by the Transporter! On its way to the Customer.";
      case 4:
        return "Medicine is delivered to the Customer";
      case 5:
  ...
  function sendPackage() {
    ...
    supplyChain.methods
      .sendPackageToEntity(customer, account, medicineAddress, signature)
      .send({ from: account })
    ...
    return (
      <div>
        ...
        <Button variant="contained" color="primary">
          <Link
            to={{
              pathname: `/customer/view-requests/${medicineAddress}`,
              query: {
